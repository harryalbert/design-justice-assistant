	...
	return (
		<>
			<div className="flex flex-col w-full h-full items-center">
				<div className="flex justify-center items-center my-2 w-11/12 text-blue-100 relative">
					<div
						className="absolute left-0 text-xl border-blue-100 border-2 rounded-full px-2 cursor-pointer"
			...
			<Popup showSelf={showInfoPopup} setShowSelf={setShowInfoPopup} />
		</>
	);
};
